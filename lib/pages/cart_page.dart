...
import 'package:plants/widgets/back_icon.dart';
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.only(top: 10, bottom: 10),
                            child: Text(value.cart[index].price.toString(), style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                          ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                InkWell(
                                  onTap: (){
                                    value.decrementCounter('plant Name');
                                  },
                                ...
                                Padding(
                                  ...
                                  child: Container( height: 30, width: 30, decoration:BoxDecoration(
                                    ...
                                    child: Center(child: Text(value.count.last.toString(), style: TextStyle( color: (value.count == 10)? Colors.red : Colors.black,fontWeight: FontWeight.bold),)),
                                  ),
                                ),
                                InkWell(
                                  onTap: (){
                                    value.incrementCounter('plant Name');
                                  },
                                  child: Container( height: 30, width: 30, decoration:BoxDecoration(
                                    color: Colors.white,
                                    borderRadius: BorderRadius.circular(3),
